 ...
 */
final class Version20200815201248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE player_statistics (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, type INT NOT NULL, value INT NOT NULL, season VARCHAR(30) NOT NULL, date DATETIME NOT NULL, INDEX IDX_BD760F1F99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE queue (id INT AUTO_INCREMENT NOT NULL, type INT NOT NULL, target_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
